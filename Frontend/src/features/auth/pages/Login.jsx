            ...
            >
                ...
                <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden" style={{ backgroundColor: '#f5f3f0' }}>
                    <img
                        ...
                        onError={(e) => {
                            e.currentTarget.src = "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=1200&auto=format&fit=crop";
                        }}
                    ...
                    <div
                        ...
                        style={{ background: 'linear-gradient(to top, rgba(27,24,20,0.68) 0%, rgba(27,24,20,0.12) 45%, transparent 100%)' }}
                    />
                    <div className="absolute inset-0 p-14 flex flex-col justify-between z-10">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-light leading-relaxed max-w-xs" style={{ color: 'rgba(255,255,255,0.7)' }}>
                                Rediscover modern luxury with curated seasonal drops and exclusive member privileges.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="w-full max-w-sm">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-9">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-4 text-[11px] uppercase tracking-[0.25em] font-medium transition-all duration-300 mt-2 cursor-pointer disabled:opacity-50"
