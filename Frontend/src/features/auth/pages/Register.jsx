...
const Register = () => {
    ...
    // used for navigating user on registering user with details
            ...
            >
                ...
                <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden" style={{ backgroundColor: '#f5f3f0' }}>
                    <img
                        ...
                        onError={(e) => {
                            e.currentTarget.src = "https://images.unsplash.com/photo-1509631179647-0177331693ae?q=80&w=1200&auto=format&fit=crop";
                        }}
